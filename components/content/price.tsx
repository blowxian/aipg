        ...
        <section className="bg-white dark:bg-gray-900" id="price">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    ...
                    <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at Flowbite we focus
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    <div
                        ...
                        <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal
                    ...
                    <div
                        ...
                        <Button size="3" asChild><a href="#">Get
                            started</a></Button>
                    </div>
                </div>
            </div>

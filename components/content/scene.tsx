                ...
                <Tabs.List justify="center">
                    <Tabs.Trigger value="content_creation">
                        <Heading as="h3" className="!text-lg md:!text-xl"><span
                            className="hidden md:inline">{t("content_creation_tab")}</span></Heading>
                    </Tabs.Trigger>
                    <Tabs.Trigger value="academic_writing">
                        <Heading as="h3" className="!text-lg md:!text-xl"><span
                            className="hidden md:inline">{t("academic_writing_tab")}</span></Heading>
                    </Tabs.Trigger>
                    <Tabs.Trigger value="personal_writing">
                        <Heading as="h3" className="!text-lg md:!text-xl"><span
                            className="hidden md:inline">{t("personal_writing_tab")}</span></Heading>
                    </Tabs.Trigger>
                </Tabs.List>

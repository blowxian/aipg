    ...
    return (
        <Section className="px-3 md:px-0 !py-6 md:!py-8">
            ...
            <Grid className="grid-cols-1 md:!grid-cols-3" gap="3" width="auto">
                <Box>
                    <Heading as="h3" align="center" className="my-2 md:my-6 !text-xl md:!text-2xl"><Em>Advanced AI
                        Technology</Em></Heading>
                    <Text as="p">
                        AI Paragraph Generator uses a large language model that learns patterns, grammar, and vocabulary
                        from
                        large amounts of text data. So it can generate human-like text based on a given prompt or input.
                    </Text>
                </Box>
                <Box>
                    <Heading as="h3" align="center" className="my-2 md:my-6 !text-xl md:!text-2xl"><Em>what is Natural
                        Language Processing (NLP)</Em></Heading>
                    <Text as="p">
                        The tool&apos;s NLP capabilities ensure the generated text is contextually rich and
                        reader-friendly, making
                        it suitable for various writing needs.
                    </Text>
                </Box>
                <Box>
                    <Heading as="h3" align="center" className="my-2 md:my-6 !text-xl md:!text-2xl"><Em>what is Machine
                        Learning Models</Em></Heading>
                    <Text as="p" mb="3">
                        The Paragraph Generator continuously improves to provide the most relevant and high-quality
                        content,
